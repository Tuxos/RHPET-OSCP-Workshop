...
Las but not least we look into the deployment log:
----
[root@workstation-835d ~]# oc logs sinatra-example-1-jm7nm
...
You can also look into all the logs through the OpenShift Webinterface.
