...
If you want to know if your Webbrowser is supported by OpenShift, please look https://access.redhat.com/articles/2176281[here^].
...
You see the same Frontend like in the lab before, but with a running database :-)
