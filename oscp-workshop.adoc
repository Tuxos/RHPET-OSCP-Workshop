...
----
NOTE: The `Template_Example.yml` file defines a template. You just added it to the instant-app project. If you add the template to the `openshift` project it made your template available throughout your OpenShift cluster.
