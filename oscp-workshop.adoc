...
Now using project "svcslab" on server "https://master-dev.example.com:8443".
...
----
[root@workstation-6180 ~]# ssh master-dev.example.com 'curl -s http://172.30.69.150:8888'
...
Now using project "explore-example" on server "https://master-dev.example.com:8443".
